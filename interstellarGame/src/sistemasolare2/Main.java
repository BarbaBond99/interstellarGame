...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException, InterruptedException, IOException {
        ...
        arr.aggiungiDomanda(d);*/
        for (int i = 0; i < Terra.getLista().length()-1; i++) {
            Terra.getLista().getDomanda(i).runDomanda();                
        }
        Impiccato im = new Impiccato("LUNA");
        System.out.println("Prova ad indovinare come si chiama!");
        im.run();
        System.out.println("Grande hai indovinato! il satellite si chiama LUNA");
